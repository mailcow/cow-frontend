  ...
  methods: {
    ...
    mousemove (e) {
      ...
      if (is_smile) {
        ...
        document.getElementById("eyebrows-happy").style.display = 'block';
        document.getElementById("eyebrow-happy-left").style.display = 'block';
        document.getElementById("eyebrow-happy-right").style.display = 'block';
        document.getElementById("mouth-worry").style.display = 'none';
        document.getElementById("eyebrow-sad-right").style.display = 'none';
        document.getElementById("eyebrow-sad-left").style.display = 'none';

      } else {
        document.getElementById("mouth-happy").style.display = 'none';
        document.getElementById("eyebrows-happy").style.display = 'none';
        document.getElementById("eyebrow-happy-left").style.display = 'none';
        document.getElementById("eyebrow-happy-right").style.display = 'none';
        document.getElementById("mouth-worry").style.display = 'block';
        document.getElementById("eyebrow-sad-right").style.display = 'block';
        document.getElementById("eyebrow-sad-left").style.display = 'block';
      }
    ...
    eyeFollow (eye) {
        var eyeOffset = this.getOffset(eye);
        var bBox = eye.getBBox();
        var centerX = eyeOffset.x + bBox.width / 2;
        var centerY = eyeOffset.y + bBox.height / 2;
        var percentTop = Math.round((this.cursorPos.y - centerY) * 100 / this.windowHeight);
        var percentLeft = Math.round((this.cursorPos.x - centerX) * 100 / this.windowWidth);
